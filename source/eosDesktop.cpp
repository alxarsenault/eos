...
eos::Core::Desktop::Desktop(const ax::Rect& rect)
//_terminal(nullptr),
//_system(system)
{
...
//	_terminal_app = new eos::AppLoader("./app/terminal.so", "TerminalMode");
	...
	_bg_img = std::shared_ptr<ax::Image>(
		new ax::Image("resource/wallpaper-standard.png"));
...
void eos::Core::Desktop::ReposAllDesktopBuiltInApps()
{
...
void eos::Core::Desktop::OnMouseLeftDown(const ax::Point& mouse)
{
//	if(_showView)
//	{
//		eos::Core::Manager* man = _system->GetManager();
...
void eos::Core::Desktop::OnMouseMotion(const ax::Point& mouse)
{
	
}

void eos::Core::Desktop::OnMouseLeftUp(const ax::Point& mouse)
{
...
void eos::Core::Desktop::OnPaint(ax::GC gc)
{

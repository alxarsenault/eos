...
LINKER_FLAG = -lpng -laxLibCore -lfreetype -lEGL -lGLESv1_CM -lpthread -lopenmaxil -lbcm_host -ldl -lutil -lsqlite3
endif


OBJ_DIR = build
MAIN_SRC = source/eosAppViewer.cpp source/ eosCoreTracer.cpp source/eosFrame.cpp source/eosStatusBar.cpp source/main.cpp source/eosCoreUser.cpp source/eosHome.cpp source/eosAlert.cpp source/eosCoreManager.cpp source/eosDesktop.cpp source/eosAppLoader.cpp source/eosCoreSystem.cpp source/eosDock.cpp source/eosNotification.cpp

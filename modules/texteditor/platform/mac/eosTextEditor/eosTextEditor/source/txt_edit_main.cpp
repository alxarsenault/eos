...
public:
		...
		axPanel(parent, rect)
	{
		...
		new ax::Button(this, ax::Rect(10, 10, 48, 48), ax::Button::Events(GetOnInfoClick()), menu_btn_info,
			"resource/info.png", "", ax::Button::Flags::SINGLE_IMG);
	}
...
int main()
{
	...
	app.AddMainEntry([&app]() { new MainPanel(&app, ax::Rect(0, 0, 512, 384)); });
